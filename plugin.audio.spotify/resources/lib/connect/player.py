"""Base Kodi player glue for Spotify Connect.

Ported from service.librespot 12.3.1.0. Used directly in the 'alsa' backend
(no Kodi playback, notifications only); subclassed for the Kodi backend.
"""
...
class Player(xbmc.Player):
    ...
    def __init__(self, target, file, librespot):
        ...
        self._dnd_kodi = utils.setting_is_true("connect_dnd_kodi")
